>[!warning]
>DEPRECATED (Cyberspace v1): this document is archived historical context and is **not** the active specification.
>
>For the current spec, see `../../CYBERSPACE_V2.md`.
...
>[!warning]
>This specification is a work in progress. When a final version is released, it will be tagged under Releases.
